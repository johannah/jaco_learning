...
class JacoInterface(JacoRobot):
    ...
    def step(self, cmd):
        if self.initialized:
            ...
            #    cmd_vel_deg = convert_to_degrees(cmd.unit, np.array(cmd.data))
            #    print("REQUESTING", cmd_vel_deg)
            ...
            if cmd.type == 'ANGLE':
                ...
                print(current_joint_angles_degrees)
                print(joint_angle_degrees)
